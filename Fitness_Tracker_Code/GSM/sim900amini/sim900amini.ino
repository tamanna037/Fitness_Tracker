...
void SendMessage()
{
  ...
  mySerial.println("AT+CMGS=\"+8801920924741\"\r"); // Replace x with mobile number
  delay(1000);
...
void MakeCall()
{
  mySerial.println("ATD+8801920924741;"); // ATDxxxxxxxxxx; -- watch out here for semicolon at the end!!//8801920924741
